...
class License
{
	...
	function ajax_check_licence()
	{
		...
		$licence          = 'B5E0B5F8DD8689E6ACA49DD6E6E1A930';
	...
	function ajax_activate_licence()
	{
		...
		$args = array(
			'licence_key' => urlencode( 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' ),
		...
		$this->set_licence_key( 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' );
		$decoded_response['masked_licence'] = $this->util->mask_licence( 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' );
	...
	function set_licence_key( $key )
	{
		...
		update_user_meta( get_current_user_id(), Helpers::USER_LICENCE_META_KEY, 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' );
	}
	...
	public function set_global_licence_key( $key ) {
		$this->settings['licence'] = 'B5E0B5F8DD8689E6ACA49DD6E6E1A930';
	...
	{
		return json_decode( $this->check_licence( 'B5E0B5F8DD8689E6ACA49DD6E6E1A930' ), true );
