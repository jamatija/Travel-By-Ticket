                ...
                <div class="destinations">
                    <div class="form-field">
                        ...
                        <div class="depart">
                            ...
                            <!-- Običan input + hidden za ID -->
                            <input type="text" 
                                   id="from-city" 
                                   placeholder="<?php echo __('Departure city', 'travel'); ?>"
                                   autocomplete="off">
                            <input type="hidden" id="from-city-id" name="from_city">
                        </div>
                    </div>
                    ...
                    <div class="form-field">
                        ...
                        <div class="final">
                            ...
                            <input type="text" 
                                   id="to-city" 
                                   placeholder="<?php echo __('Destination', 'travel'); ?>"
                                   autocomplete="off">
                            <input type="hidden" id="to-city-id" name="to_city">
                        </div>
                    </div>
                </div>
                <!-- END DESTINATIONS -->
