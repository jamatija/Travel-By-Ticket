...
class ShapedImageWidget extends \Elementor\Widget_Base
{
    ...
    protected function get_mobile_mask_svg() {
        $svg = '<svg viewBox="0 0 440 393" xmlns="http://www.w3.org/2000/svg"><path d="M462.202 0.0269028L337.808 0C332.224 23.1364 311.346 40.3542 286.42 40.3542C261.495 40.3542 240.616 23.1633 235.032 0H172.676C158.784 0 146.213 8.17845 140.603 20.8497L-2.50187 344.383L-67 344.463V392.646H79.681C85.2649 369.51 106.144 352.292 131.069 352.292C155.994 352.292 176.873 369.483 182.457 392.646H265.687C279.579 392.646 292.15 384.468 297.761 371.797L440.838 48.3174H495.733V0H433.637L462.202 0.0269028Z" fill="white"/></svg>';
